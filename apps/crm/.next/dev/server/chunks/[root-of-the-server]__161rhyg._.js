...
"[project]/apps/crm/src/app/api/v1/customers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$customerService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/customerService.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    ...
    const customers = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$customerService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customerService"].getCustomers(tenant.id);
...
async function POST(request) {
    try {
        ...
        const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$customerService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customerService"].createCustomer({
            first_name,
            last_name,
            email,
            phone,
...
"[project]/apps/crm/src/lib/services/customerService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$eventBus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/eventBus.ts [app-route] (ecmascript)");
;
;
class CustomerService {
    customers = new Map(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$shared$2f$data$2f$traviaData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHARED_CUSTOMERS"].map((c)=>[
            c.id,
            c
        ]));
    async getCustomers(tenantId) {
        return Array.from(this.customers.values()).filter((c)=>c.company_id === tenantId || tenantId === 'a0000000-0000-0000-0000-000000000001' && !c.company_id);
    }
    ...
    async createCustomer(input, tenantId) {
        const newCustomer = {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$eventBus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eventBus"].publish('CustomerCreated', tenantId, {
...
"[project]/apps/crm/src/lib/services/eventBus.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DomainEventBus {
    ...
    async publish(eventType, tenantId, payload, metadata) {
        const event = {
...
"[project]/apps/crm/src/lib/services/index.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
/**
 * TRAVEL OS — Domain Services Exports
 * Modular Monolith Service Layer
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$eventBus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/eventBus.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$customerService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/customerService.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$tripService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/tripService.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$leadService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/crm/src/lib/services/leadService.ts [app-route] (ecmascript)");
;
;
;
;
}),
"[project]/apps/crm/src/lib/services/leadService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class LeadService {
    ...
    async createLead(input, tenantId) {
        const newLead = {
        ...
        // Publish domain event
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$eventBus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eventBus"].publish('LeadCreated', tenantId, {
            leadId: newLead.id,
...
"[project]/apps/crm/src/lib/services/tripService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
class TripService {
    trips = new Map(Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$shared$2f$data$2f$traviaData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHARED_TRIPS"]).map((t)=>[
            t.id,
            t
        ]));
    async getTrips(tenantId) {
        return Array.from(this.trips.values()).filter((t)=>t.company_id === tenantId || tenantId === 'a0000000-0000-0000-0000-000000000001' && !t.company_id);
    }
    async getTripById(id, tenantId) {
    ...
    async createTrip(input, tenantId) {
        const newTrip = {
        ...
        // Publish domain event
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$crm$2f$src$2f$lib$2f$services$2f$eventBus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eventBus"].publish('TripCreated', tenantId, {
            tripId: newTrip.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__161rhyg._.js.map